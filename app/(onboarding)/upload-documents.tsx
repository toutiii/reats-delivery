...
const UploadDocumentsScreen: React.FC = () => {
   ...
   const {
      ...
      error: frontError,
      takePicture: takeFrontPicture,
      pickImage: pickFrontImage,
   ...
   const {
      ...
      loading: backLoading,
      error: backError,
      takePicture: takeBackPicture,
      pickImage: pickBackImage,
      ...
      (side: CardSide) => {
         if (Platform.OS === 'ios') {
            ActionSheetIOS.showActionSheetWithOptions(
               ...
               buttonIndex => {
                  if (buttonIndex === 1) {
                     side === 'front' ? takeFrontPicture() : takeBackPicture();
                  } else if (buttonIndex === 2) {
                     side === 'front' ? pickFrontImage() : pickBackImage();
                  }
               }
            );
         } else {
               ...
               <View className="flex-1 px-6 pt-4">
                  ...
                  <VStack space="xl">
                     ...
                     <UploadSection
                        ...
                        image={frontImage}
                        onUpload={() => handleUploadPress('front')}
                     ...
                     <UploadSection
                        ...
                        image={backImage}
                        onUpload={() => handleUploadPress('back')}
         ...
         >
            ...
            >
               <ButtonText className="text-white text-lg font-medium">
                  {frontLoading || backLoading ? 'Chargement...' : 'Submit'}
               </ButtonText>
            </Button>
         </Box>
      </ThemedView>
         ...
         {uploaded ? (
            ...
            <Box className="w-full items-center">
               ...
               <Pressable
                  ...
                  accessibilityLabel="Change uploaded photo"
