...
export default function StatsView() {
  ...
  const [originalStartDate, setOriginalStartDate] = React.useState("");

  const [endDate, setEndDate] = React.useState("");

  const [originalEndDate, setOriginalEndDate] = React.useState("");

  const [isRequesting, setIsRequesting] = React.useState(false);

  const [showStartDateMode, setShowStartDateMode] = React.useState(false);

  const [showEndDateMode, setShowEndDateMode] = React.useState(false);

  const [showAlert, setShowAlert] = React.useState(false);

  const [showAlertBothDatesMandatory, setShowAlertBothDatesMandatory] =
