        ...
        <Pressable style={{ flex: 1 }} onPress={() => Keyboard.dismiss()}>
          <VStack className="flex-1 px-6" space="xl">
            ...
            <Center className="justify-center my-8">
              <Animated.Image entering={FadeIn.delay(300).duration(800)} style={{ width: 100, height: 100 }} source={require("@/assets/images/logos/logo.png")} resizeMode="contain" accessibilityLabel="Logo de l'application Delivery" />
